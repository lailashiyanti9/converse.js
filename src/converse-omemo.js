            ...
            handleError (e) {
                ...
                if (e.name === 'IQError') {
                    ...
                    if (sizzle(`presence-subscription-required[xmlns="${Strophe.NS.PUBSUB_ERROR}"]`, e.iq).length) {
                        ...
                        err_msgs.push(__("Sorry, unable to send an encrypted message because %1$s "+
    ...
    initialize () {
        ...
        _converse.DeviceList = Backbone.Model.extend({
            ...
            publishDevices () {
                ...
                // TOOD: first check whether publish-options is supported
                stanza.up().up().up().up(); // Go back to 'publish'
